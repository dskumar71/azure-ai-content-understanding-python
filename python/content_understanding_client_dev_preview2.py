...
class AzureContentUnderstandingClient:
    ...
    def _get_analyzer_url(self, endpoint, api_version, analyzer_id):
        return f"{endpoint}/contentunderstanding/v2025-05-01-preview/analyzers/{analyzer_id}?api-version={api_version}"  # noqa

    def _get_analyzer_list_url(self, endpoint, api_version):
        return f"{endpoint}/contentunderstanding/v2025-05-01-preview/analyzers?api-version={api_version}"

    def _get_analyze_url(self, endpoint, api_version, analyzer_id):
        return f"{endpoint}/contentunderstanding/v2025-05-01-preview/analyzers/{analyzer_id}:analyze?api-version={api_version}"  # noqa
